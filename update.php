...
<body class="bg-dark">
    <div class="d-flex justify-content-center align-items-center h-100 mt-5">
        <div class="card p-5" style="width: 80rem;">
            <h5 class="card-title text-center mb-4">Update</h5>
            <?php
            ...
            <form action="./config/Process.php" method="post">
                <div class="form-group">
                    <input type="text" class="form-control form-control-lg" value="<?php echo $id ?>" name="id_update" hidden>
                </div>
                <div class="form-group">
                ...
                <button type="submit" class="btn btn-success btn-block btn-lg mt-3" name="update">Submit</button>
            </form>
        </div>
    </div>
</body>
